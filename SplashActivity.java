...
//			Share.locale = context.getResources().getConfiguration().locale.getDisplayCountry();
	...
	private class registerBackground extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			...
			pd = new ProgressDialog(context, R.drawable.logo);
	...
	private void changeImage() {
		...
		if (counter == 2) {
			...
			if (Share.splogin.getBoolean("firsttime", true)) {
				CommonFunctions.changeactivity(context, "ShowOnce", true,true);
				...
				CommonFunctions.changeactivity(context, "LoginActivity", false,true);
...

	{
		...
		if(mProgressDialog == null)
			...
			mProgressDialog = new TransparentProgressDialog(SplashActivity.this, R.drawable.logo);;
