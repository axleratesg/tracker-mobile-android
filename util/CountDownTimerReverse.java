 ...
 */
public abstract class CountDownTimerReverse {
	 ...
	 *            callbacks.
	 */
	public CountDownTimerReverse(long millisInFuture, long countDownInterval) {
	 ...
	 * 
	 * Do not call it from inside CountDownTimerReverse threads
	 */
	 ...
	 * Start the countdown.
	 */
	public synchronized final CountDownTimerReverse start() {
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			synchronized (CountDownTimerReverse.this) {
				if (!mPaused) {
